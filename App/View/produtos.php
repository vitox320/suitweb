...
<div class="container">
    ...
    <div class="row">
        ...
        <?php
        $listagem = \App\Model\Conexao::getConexao()->prepare("SELECT * FROM tb_produto");
        $listagem->execute();
...
<footer>
    <div class="container mt-5 py-5">
        ...
        <div class="row d-flex justify-content-center">
            ...
            <div style="font-size: smaller" class="text-white"> <a href="InserirProduto.php">Inserir Produtos</a> </div>
        </div>
